...
* **Dynamic Currency Switching:** Users can instantly convert all displayed prices between **USD ($\$)**, **Euro (€)**, and **Indian Rupee (₹)**.
...
## CoinVista/
## ├── src/
## │   ├── components/       # Reusable UI elements (Navbar, LineChart, Footer)
## │   ├── context/          # State management logic
## │   │   └── CoinContext.jsx # Global state for coins and currency
## │   ├── pages/            # Main page components
## │   │   ├── Home.jsx      # Homepage with table and search
## │   │   └── Coin.jsx      # Detail page with charts
## │   └── App.jsx
## └── package.json 
